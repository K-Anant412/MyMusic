    ...
    <>
      ...
      />
        <section className='w-full h-full shrink-0 flex py-3 md:p-5 items-center justify-center flex-col md:flex-row gap-3 md:gap-8'>
          ...
          <div className='border hidden md:flex border-white/20 z-20 bg-white/10 backdrop-blur-md rounded-2xl w-[30%] h-full shrink-0 flex-col items-center justify-around pt-5 shadow-[6px_8px_20px_rgba(0,0,0,0.22),-8px_-8px_20px_rgba(255,255,255,0.12)]'>
